...
function LaundererOrdersDetail() {
  ...
  const handleDeliveryStatus = async (order_id) => {
    try {
  ...
  const handleDeleteOrder = async () => {
    try {
      handleToast('Delete functionality not implemented yet', '', 'warning');
    } catch (err) {
      handleToast('Error Deleting Order', err.message, 'error');
    }
  };
              ...
              <Tr key={order._id}>
                ...
                <Td textAlign="right">
                  <Flex gap={4} w="fit-content" justify="flex-end">
                    ...
                    <Button
                      colorScheme="green"
                      isDisabled={order.acceptedStatus}
                    ...
                    <Button
                      colorScheme="orange"
                      isDisabled={!order.acceptedStatus || order.deliveredStatus}
              ...
              <Grid templateColumns="repeat(2, 1fr)" gap={4} my={4}>
                <GridItem>
                  ...
                  <Switch
                    ...
                    onChange={() => handleAcceptOrder(selectedOrder._id)}
                  />
                </GridItem>
                <GridItem>
                  <Text>
                  ...
                  <Switch
                    ...
                    onChange={() => handleDeliveryStatus(selectedOrder._id)}
                  />
                </GridItem>
                <GridItem>
                  <Text>
